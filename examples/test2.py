...
def ppb_task():
    ...
    ppbmt_one.setConfigDir("/Users/don_williams09/TP_IA/Cases Studies/pyppbox/examples/my_config",load_all=True)
    ppbmt_two.setConfigDir("/Users/don_williams09/TP_IA/Cases Studies/pyppbox/examples/cfg",load_all=True)
        ...
        if hasFrame:
            ...
            for person in reidentified_people_one:
                ...
                if person.deepid == "Unknown" and person.faceid == "Unknown" :  # Si la personne n'est pas reconnue
                    message = "Unknown, please go to identification"
